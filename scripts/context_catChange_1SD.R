#script para avaliar mudança nos indicadores de desenvolvimento em municípios
#com valores extremos (SD >= 1) de mudança em floresta e FPP
...
ggarrange(expov_diff, gini_diff, agrifam_diff, pop_urb_diff, IDHL_diff, u5mort_diff,
          common.legend = T) %>% 
  ggsave(filename = here("img/fig_1SD_diff.jpg"), bg = "white", width = 10)
